...
module.exports = function (options, callback) {
  ...
  async.parallel({
    ...
    if (err) {
      ...
      return errs.create({
        message: 'No active tasks returned from CouchDB',
        reason:  results.tasks && results.tasks.reason,
        code:    results.tasks && results.tasks.error
      });
    }
